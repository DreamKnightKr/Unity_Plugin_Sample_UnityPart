...
class ModuleWebBrowserBoo_Android (ModuleWebBrowserBoo_Dummy): 
	...
	public override def GetName() as string :
		return "Android"
	
	public override def GetVersion() as string :
		return "v1.0.0"
	
	public override def OpenWebPage(url as string) as void:
